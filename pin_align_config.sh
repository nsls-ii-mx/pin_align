...
PIN_ALIGN_DEFAULT_ROI_WIDTH_OFFSET=$(( 480 ))
...
#PIN_ALIGN_PIN_TIP_WINDOW="266x400+375+312" #original 
PIN_ALIGN_PIN_TIP_WINDOW="${PIN_ALIGN_DEFAULT_ROI_WIDTH}x400+$PIN_ALIGN_DEFAULT_ROI_WIDTH_OFFSET+$PIN_ALIGN_DEFAULT_ROI_HEIGHT_OFFSET"
PIN_ALIGN_BASE_WINDOW="50x400+650+${PIN_ALIGN_DEFAULT_ROI_HEIGHT_OFFSET}"
PIN_ALIGN_SUB_BASE_WINDOW="80x400+765+${PIN_ALIGN_DEFAULT_ROI_HEIGHT_OFFSET}"
############################################################
...
#	width x height + horizontal offset + vertical offset (offsets origin is top left corner) Note: vertical offset must be the same for all.
#PIN_ALIGN_PIN_TIP_WINDOW="266x400+375+312" #original 
PIN_ALIGN_PIN_TIP_WINDOW="${PIN_ALIGN_DEFAULT_ROI_WIDTH}x400+${PIN_ALIGN_ROI_WIDTH_OFFSET}+${PIN_ALIGN_ROI_HEIGHT_OFFSET}"
PIN_ALIGN_BASE_WINDOW="50x400+650+${PIN_ALIGN_ROI_HEIGHT_OFFSET}"
PIN_ALIGN_SUB_BASE_WINDOW="80x400+765+${PIN_ALIGN_ROI_HEIGHT_OFFSET}"
